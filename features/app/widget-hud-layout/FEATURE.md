...
|------|------|-------------|
| 2026-03-26 | [01-ios-hud-layout](specs/01-ios-hud-layout/spec.md) | iOS priority modes (P1/P2/P3), SmallWidget font fix, todayDelta row, Large bottom padding — **Complete** |
