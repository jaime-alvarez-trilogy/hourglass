...
|------|------|-------------|
| 2026-03-19 | [01-design-tokens](specs/01-design-tokens/spec-research.md) | Typography system migration + text color desaturation |
...
| 2026-03-19 | [06-native-tabs](specs/06-native-tabs/spec-research.md) | NativeTabs migration |
| 2026-03-19 | [07-shared-transitions](specs/07-shared-transitions/spec-research.md) | Shared Element Transitions on key navigations |
