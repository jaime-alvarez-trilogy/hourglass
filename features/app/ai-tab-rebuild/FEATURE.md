...
| 2026-03-16 | [02-safe-cone-scrub](specs/02-safe-cone-scrub/spec-research.md) | Gate AIConeChart scrub useAnimatedReaction behind animation-complete state |
| 2026-03-16 | [03-backfill-relocation](specs/03-backfill-relocation/spec-research.md) | Move useHistoryBackfill to _layout.tsx; remove from tab-level screens |
