...
- 2026-03-15: [03-touch-and-navigation](specs/03-touch-and-navigation/spec.md) — Spec ready. AnimatedPressable primitive, FadeInScreen translateY spring entrance, HapticTab scale pulse, ApprovalCard/modal button migration. 4 FRs.
