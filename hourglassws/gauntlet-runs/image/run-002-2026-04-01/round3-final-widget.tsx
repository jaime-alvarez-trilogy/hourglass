...
const COLORS = {
  bgDark:        '#0D0C14',
  surface:       '#16151FCC', // 80% opacity glass
...
// Bar chart height constant (tests expect ~100pt max)
...
function GlassCard({
  ...
  return (
    <ZStack>
      ...
      <RoundedRectangle cornerRadius={14} stroke={borderColor} strokeWidth={1} />
      <VStack padding={12} alignment="leading" spacing={4}>
        {children}
      </VStack>
    </ZStack>
  );
...
function StatusPill({ paceBadge }: { paceBadge: string }) {
  ...
  const urgencyForPace: Record<string, string> = {
    crushed_it: 'low',
    on_track:   'none',
    behind:     'low',
    critical:   'critical',
  ...
  const color = URGENCY_ACCENT[urgencyForPace[paceBadge] ?? 'none'] ?? URGENCY_ACCENT.none;

  return (
    <ZStack>
      <RoundedRectangle fill={color + '25'} cornerRadius={10} />
...
function MetricView({
  ...
  return (
    <VStack alignment="leading" spacing={2}>
      ...
      <Text font={{ size, weight: 'heavy', design: 'monospaced' }} foregroundStyle={valueColor}>
        {value}
      </Text>
    </VStack>
  );
...
// 01-ios-hud-layout FR2: hero font weight: 'heavy', design: 'monospaced'
  ...
  return (
    <ZStack>
      ...
      <VStack padding={14} alignment="leading" spacing={6}>
        ...
        {/* FR2: weight 'heavy', design 'monospaced' */}
        <Text
      ...
      <VStack padding={14} spacing={10}>
        ...
        {priority === 'approvals' && (
          <>
              ...
              <HStack key={item.id} spacing={6}>
                <ZStack>
                  ...
                  <HStack padding={10} spacing={6}>
                    ...
                    <Spacer />
                    <Text font={{ size: 11, design: 'monospaced' }} foregroundStyle={COLORS.gold}>
                      {item.hours}
                    </Text>
            ...
            <HStack>
              <Text font={{ size: 12, design: 'monospaced' }} foregroundStyle={accent}>
                {props.hoursDisplay}
              </Text>
              <Spacer />
        ...
        {priority === 'deficit' && (
          <>
            ...
            <Spacer />
            <HStack>
              <Text font={{ size: 13, design: 'monospaced' }} foregroundStyle={accent}>
        ...
        {priority === 'default' && (
          <>
            ...
            <HStack>
              ...
              <Spacer />
              <Text font={{ size: 12, design: 'monospaced' }} foregroundStyle={COLORS.cyan}>
                AI: {props.aiPct}
              </Text>
            </HStack>
            {isStale(props.cachedAt) && (
      ...
      <VStack padding={{ top: 16, leading: 16, trailing: 16, bottom: 28 }} spacing={12} alignment="leading">
              ...
              <HStack key={item.id} spacing={8}>
                <ZStack>
                  ...
                  <HStack padding={12} spacing={8}>
                    ...
                    <Spacer />
                    <Text font={{ size: 12, design: 'monospaced' }} foregroundStyle={COLORS.gold}>
                      {item.hours}
                    </Text>
                    <Text font={{ size: 11 }} foregroundStyle={COLORS.textSecondary}>
                      {item.category}
        ...
        {priority === 'deficit' && (
          <>
            ...
            <Text font={{ size: 48, weight: 'heavy', design: 'monospaced' }} foregroundStyle={accent}>
              {props.hoursDisplay}
            </Text>
            <Spacer />
            <HStack spacing={10}>
              ...
              <GlassCard borderColor={COLORS.cyan + '50'}>
                <MetricView label="AI" value={props.aiPct} valueColor={COLORS.cyan} size={16} />
              </GlassCard>
              <GlassCard borderColor={COLORS.violet + '50'}>
